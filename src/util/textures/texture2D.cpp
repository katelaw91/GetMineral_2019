...
Texture2D::Texture2D(const string& side, const string& top)
	: mTexture(0)
{
...
Texture2D::Texture2D(const string& side, const string& top, const string &bottom)
	: mTexture(0)
{
	texture.push_back(side);
	texture.push_back(side);
...
Texture2D::Texture2D(const string& front, const string& back, const string& right, const string& left, const string& top, const string& bottom)
	: mTexture(0)
{
...
bool Texture2D::loadTexture(bool generateMipMaps)
{
